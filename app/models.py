...
# Auxiliary Table. Does not need to be declared as a model class
...
class User(UserMixin, db.Model):
    ...
    def get_avatar(self, size):
        digest = md5(self.email.lower().encode('utf-8')).hexdigest() # return string
        return 'https://www.gravatar.com/avatar/{}?d=identicon&s={}'.format(digest, size)

    # Queries followed relationship for matching follower
    ...
    def followed_posts(self):
        # Join Post table with followers where followed_id == Post.user_id
